# Messenger Remote Control v0.3.8
...
**Master만 0.3.8로 업그레이드하면 기존 Slave v0.3.0~0.3.7과 함께 사용할 수 있습니다.** 프로토콜은 0.3.0이며 연결파일·설정·송부 이력은 유지됩니다. Slave 0.3.8 설치파일도 함께 배포하지만 Slave는 버전 표기 외에 달라지는 것이 없습니다.
