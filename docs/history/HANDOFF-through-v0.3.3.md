# Historical handoff through v0.3.3

Archived on 2026-09-21 from commit `99b6b1f4c7251a78999ea7b5c4b99d3e9ede5459`.
Read the [current HANDOFF](../../HANDOFF.md) and [contributor instructions](../../AGENTS.md) first.

This is dated evidence, not current operating instructions. Older sections retain superseded rules, including five-line excerpts, prerelease delivery and no window restoration. Relative document links were adjusted for this archive location. Raw field logs and local test artifacts are not included.
